...
DEFAULT_LINKEDIN_PROMPT = (
    ...
    "CRITICAL NEGATIVE CONSTRAINTS (Violating these will fail the generation):\n"
    "1. NO EMOJIS. Not a single emoji is allowed.\n"
    "2. NO PROMOTIONAL LANGUAGE. Do not write 'Read my article', 'Check out the link', 'Deep dive below', or point to any external content. This text IS the final product.\n"
    "3. NO EM DASHES. Do not use the '—' or '-' character to connect sentences. Use standard punctuation like commas or periods instead.\n"
    ...
    "Tone:\n"
    "Authoritative, direct, and analytical. Connect the dots between the news items to reveal a larger market trend."
)
