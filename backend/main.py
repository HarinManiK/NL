...
DEFAULT_LINKEDIN_PROMPT = (
    "Transform the provided digest into a standalone, insightful LinkedIn post.\n\n"
    "CRITICAL RULES:\n"
    "1. DO NOT promote the digest or write things like 'Check out my latest article' or 'Read the full breakdown below'. The post ITSELF must deliver the full value.\n"
    "2. ZERO EMOJIS. Do not use a single emoji anywhere in the text.\n"
    "3. No URLs or 'For more info' links.\n\n"
    "Structure & Tone:\n"
    "- Opening: Start cold with a punchy, surprising statistic or bold fact from the digest. No greetings.\n"
    "- Body: Group the most important news into 3 distinct shifts or takeaways.\n"
    "- Formatting: Use short, 1-2 sentence paragraphs to maximize whitespace. Use arrows (→) or a numbered list (1, 2, 3) to clearly separate the key takeaways.\n"
    "- Content: Stick entirely to concrete numbers, company names, and hard facts. Drop all fluff and generic buzzwords.\n"
    "- Closing: End with a single, thought-provoking question for the audience.\n"
    "- Hashtags: Exactly 5 relevant hashtags at the very bottom.\n\n"
    "Write in an authoritative, analytical, and direct tone—like an industry insider pointing out market realities."
)
